...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        if width > 0:
            ...
            raise ValueError("Width needs to be a non-zero positive")

        if height > 0:
            self.height = height
        else:
            raise ValueError("Height needs to be a non-zero positive")

        self.cleanTiles = set() #This is a set of integer tuples co-ordinates that are clean
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        int_x = math.floor(pos.getX())
        int_y = math.floor(pos.getY())
        self.cleanTiles.add((int_x,int_y))
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        new_pos = old_pos.getNewPosition(self.getRobotDirection(),self.speed)
        while(not self.room.isPositionInRoom(new_pos)):
            new_dir = random.randint(0,360)
            new_pos = old_pos.getNewPosition(new_dir,self.speed)
...
#     plot.
#
# showPlot1('Mean times for different strategies','robot','mean-time')
#
...
#
#       (... your call here ...)
showPlot2('Aspect ratio effect on cleaning','aspect ratio','time')
#
...
#     print(robot.getRobotPosition())
    ...
    # pos1 = Position(4.00,4.00)
    # pos2 = Position(2.00, 8.00)
    # pos3 = Position(5.00, 4.00)
    # pos4 = Position(1.00, 2.00)
    # pos5 = Position(3.00, 3.00)
    # pos_list = [pos1,pos2,pos3,pos4,pos5]
    # for p in pos_list:
